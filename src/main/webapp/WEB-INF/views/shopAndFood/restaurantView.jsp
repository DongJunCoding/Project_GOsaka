...
RestaurantTO restaurantView = (RestaurantTO)request.getAttribute("to");

StringBuilder sbHtml = new StringBuilder();

String resId = restaurantView.getRestaurantId();
String imageUrl = restaurantView.getImageUrl();
String title = restaurantView.getRtitle();
String content = restaurantView.getRcontent();
String latitude = restaurantView.getLatitude();
String longitude = restaurantView.getLongitude();
...
if (content.indexOf("[구글") != -1 && content.indexOf("<이용") != -1) {
	startIdx = content.indexOf("[구글");
	endIdx = content.indexOf("<이용");
	
} else if (content.indexOf("[구글") != -1) {
	startIdx = content.indexOf("[구글");
	endIdx = content.indexOf("영업", startIdx);
	
} else if (content.indexOf("[위치") != -1 && content.indexOf("<이용") != -1) {
	startIdx = content.indexOf("[위치");
	endIdx = content.indexOf("<이용");
	
} else if (content.indexOf("[위치") != -1) {
	startIdx = content.indexOf("[위치");
	endIdx = content.indexOf("영업", startIdx);
}
