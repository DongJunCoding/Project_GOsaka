...
<!doctype html>
<%
ArrayList<RestaurantTO> restaurantList = (ArrayList)request.getAttribute("restaurantList");
PageListTO pageTO = (PageListTO) request.getAttribute("pageTO");
ArrayList<RestaurantTO> restaurantPageList = pageTO.getRestaurantPageList();
...
totalsize = restaurantList.size();

StringBuilder sbHtml = new StringBuilder();

String imageUrl = null;
String title = null;
if (restaurantPageList.size() != 0) {
	for (RestaurantTO to : restaurantPageList) {
		String resId = to.getRestaurantId();
		...
		sbHtml.append("<div class='mask'><a href='/restaurantView.do?restaurantId=" + resId + "'>GO</a></div>");
		sbHtml.append("</div>");
		sbHtml.append("</li>");

	}
} else if (restaurantPageList.size() == 0) {
...
<html class="no-js" lang="en">
	...
	<body>
        ...
        <div class="culmn">
			...
			<section id="restaurant-list" class="home bg-black fix">
                        ...
                        <div class="main_home text-center">
                            <div class="col-md-12">
                                <div class="hello">
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h1 class="text-yellow">Restaurant Guide </h1>                                                                              
            ...
            <div class="container">
                <div class=" title">
                	<div class="counter_text" style="color:black; padding:center; ">	
        				<span style="font-size:60px;"> Restaurant  <span style="font-size:60px; color:red;"> ♥ </span></span> </span><span class="counter" style="text-decoration:none; font-size:60px;"><%=totalsize %></span>  
        				<p> </p>                  
    				</div> 
	            </div>
	            <ul class="nav2 nav2-pills">
	                ...
	                <li class="filter active" data-filter="web">
	                    <a href="/foodList.do">음식</a>
	                </li>                               
	                <li class="" data-filter="identity" style="float: right; display: flex; align-items: center;">
	                	<!-- 검색어 넘겨주는 부분 -->
					    <form action="/restaurantList.do" method="post" name="ofrm" style="display: flex; align-items: center;">
		...
		<div>
			...
			if (searchWord == null) {
				if (startBlock == 1) {
					...
					out.println("<span><a href='/restaurantList.do?cpage=" + (startBlock - blockPerPage) + "'>&lt;&lt;</a></span>");
				}
				...
				if (cpage == 1) {
					...
					out.println("<span><a href='/restaurantList.do?cpage=" + (cpage - 1) + "'>&lt;</a></span>");
				}
				out.println("&nbsp;&nbsp;");
				...
				out.println("<span><a href='/restaurantList.do?cpage=" + i + "'>" + i + "</a></span>");
					}
				}
				...
				if (startBlock == 1) {
					...
					out.println("<span><a href='/restaurantList.do?cpage=" + (startBlock - blockPerPage) + "&searchWord="+searchWord+"'>&lt;&lt;</a></span>");
				}
				...
				if (cpage == 1) {
					...
					out.println("<span><a href='/restaurantList.do?cpage=" + (cpage - 1) + "&searchWord="+searchWord+"'>&lt;</a></span>");
				}
				out.println("&nbsp;&nbsp;");
				for (int i = startBlock; i <= endBlock; i++) {
					if (i == cpage) {
				...
				// 페이지 번호들 나열해주고 해당 페이지의 데이터(게시글)들을 보여준다
				out.println("<span><a href='/restaurantList.do?cpage=" + i + "&searchWord="+searchWord+"'>" + i + "</a></span>");
					}
				}
