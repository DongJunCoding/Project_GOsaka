...
TipBoardTO to = (TipBoardTO)request.getAttribute("to");

int cpage = (Integer)request.getAttribute("cpage");

String tipId = to.getTipId();
String twriter = to.getTwriter();
String tsubject = to.getTsubject();
String tcontent = to.getTcontent();
...
<script type="text/javascript">
	window.onload = function() {
		document.getElementById('wbtn').onclick = function() {
			if (document.wfrm.tsubject.value.trim() == '') {
				alert('제목을 입력하셔야 합니다');
				return false;
			}
			if (document.wfrm.tcontent.value.trim() == '') {
				alert('내용을 입력하셔야 합니다');
				return false;
			}
	...
	%>	
		...
		<!-- 상단 디자인 -->
<div class="contents1"> 
	<form action="/tipBoardModify_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th class="top">글쓴이</th>
					<td class="top" colspan="3"><input type="text" name="twriter" value="<%=twriter %>" class="board_view_input_mail" maxlength="5" style="height:25px;" readonly/></td>
				</tr>
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="tsubject" value="<%=tsubject %>" class="board_view_input" style="height:25px;"/></td>
				</tr>
				<tr>
					<th>내용</th>
					<td colspan="3">
						<textarea name="tcontent" class="board_editor_area" style="height:500px;"><%=tcontent %></textarea>
					</td>
				</tr>
				<tr>
