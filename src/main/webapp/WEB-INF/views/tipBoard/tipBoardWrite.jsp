...
<script type="text/javascript">
	...
	%>
		...
		<!-- 상단 디자인 -->
<div class="contents1"> 
	<form action="/tipBoardWrite_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th class="top">글쓴이</th>
					<td class="top" colspan="3"><input type="text" name="twriter" value="<%=nickSession %>" class="board_view_input_mail" maxlength="10" style="height:25px;" /></td>
				</tr>
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="tsubject" value="" class="board_view_input" style="height:25px;"/></td>
				</tr>
				<tr>
					<th>내용</th>
					<td colspan="3">
						<textarea name="tcontent" class="board_editor_area" style="height:500px;"></textarea>
					</td>
				</tr>
				<tr>
					<th>이미지</th>
