...
ReviewBoardTO to = (ReviewBoardTO)request.getAttribute("to");

int cpage = (Integer)request.getAttribute("cpage");

String category = to.getCategory();
String rvId = to.getReviewId();
String rvwriter = to.getRvwriter();
String rvsubject = to.getRvsubject();
...
<script type="text/javascript">
	...
	%>
		...
		<!-- 상단 디자인 -->
<div class="contents1"> 
	<form action="/reviewBoardModify_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
		<input type="hidden" name="reviewId" value="<%=rvId %>" />
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th class="top">글쓴이</th>
					<td class="top" colspan="3"><input type="text" name="rvwriter" value="<%=rvwriter %>" class="board_view_input_mail" maxlength="5" style="height:25px;" readonly/></td>
				</tr>
				<tr>
					<th>제목</th>
					<td colspan="3">
						...
						<input type="text" name="rvsubject" value="<%=rvsubject %>" class="board_view_input" style="height:25px;"/>
					</td>
				</tr>
				<tr>
					<th>내용</th>
					<td colspan="3">
						<textarea name="rvcontent" class="board_editor_area" style="height:500px;"><%=rvcontent %></textarea>
					</td>
				</tr>
				<tr>
