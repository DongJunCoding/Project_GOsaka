...
<!doctype html>
<%
ArrayList<FestivalTO> osakaFestivalList = (ArrayList) request.getAttribute("osakaFestivalList");

String idSession = (String)session.getAttribute("loginId");
String nickSession = (String)session.getAttribute("nickname");
String role = (String)session.getAttribute("role");

int totalsize = osakaFestivalList.size();
...
for (FestivalTO to : osakaFestivalList) {
...
<html class="no-js" lang="en">
	...
	<body>
        ...
        <div class="culmn">
			...
			<section id="osakaFestival" class="home bg-black fix">
                        ...
                        <div class="main_home text-center">
                            <div class="col-md-12">
                                <div class="hello">
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h1 class="text-yellow">Osaka Festival </h1>                                                                              
            ...
            <div class="container">
                <div class=" title">
                	<div class="counter_text" style="color:black; padding:center; ">	
        				<span style="font-size:60px;"> Osaka Festival  <span style="font-size:60px; color:red;"> ♥ </span></span> </span><span class="counter" style="text-decoration:none; font-size:60px;"><%=totalsize %></span>  
        				<p> </p>                  
    				</div> 
	            </div>
