<%@page import="com.example.model.PassTicketTO"%>
...
<!doctype html>
<%
ArrayList<PassTicketTO> passticketList = (ArrayList) request.getAttribute("passticketList");
PageListTO pageTO = (PageListTO) request.getAttribute("pageTO");
ArrayList<PassTicketTO> pageList = pageTO.getPassticketPageList();
...
if (pageList.size() != 0) {
	for (PassTicketTO to : pageList) {
		String ptId = to.getPtId();
		ptImage = to.getPtImage();
		ptName = to.getPtName();

		sbHtml.append("<li class='span4 mix all'>");
		sbHtml.append("<div class='thumbnail'>");
		sbHtml.append("<img src=" + ptImage + " alt='project 7' style='width:auto; height:auto;' />");
		sbHtml.append("<div class='mask' style='font-size:30px;'><a>"+ ptName +"</a></div>");
		sbHtml.append("</div>");
		sbHtml.append("</li>");
	}
...
<html class="no-js" lang="en">
	...
	<body>
        ...
        <div class="culmn">
			...
			<section id="passticketlist" class="home bg-black fix">
                        ...
                        <div class="main_home text-center">
                            <div class="col-md-12">
                                <div class="hello">
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h1 class="text-yellow">PASS & TICKET</h1>                                                                              
            ...
            <div class="container">
                <div class=" title">
	               <div class="counter_text" style="color:black; padding:center; ">	
        				<span style="font-size:60px;"> PASS & TICKET <span style="font-size:60px; color:#8b00ff;">♥ </span></span> </span><span class="counter" style="text-decoration:none; font-size:60px;">29</span>  
        				<p> </p>                  
    				</div> 
	            </div>
			...
			<div>
				...
				if (searchWord == null) {
					if (startBlock == 1) {
						...
						out.println("<span><a href='/passticketList.do?cpage=" + (startBlock - blockPerPage) + "'>&lt;&lt;</a></span>");
					}
					...
					if (cpage == 1) {
						...
						out.println("<span><a href='/passticketList.do?cpage=" + (cpage - 1) + "'>&lt;</a></span>");
					}
					out.println("&nbsp;&nbsp;");
					...
					out.println("<span><a href='/passticketList.do?cpage=" + i + "'>" + i + "</a></span>");
						}
					}
					...
					if (startBlock == 1) {
						...
						out.println("<span><a href='/passticketList.do?cpage=" + (startBlock - blockPerPage) + "&searchWord="+searchWord+"'>&lt;&lt;</a></span>");
					}
					...
					if (cpage == 1) {
						...
						out.println("<span><a href='/passticketList.do?cpage=" + (cpage - 1) + "&searchWord="+searchWord+"'>&lt;</a></span>");
					}
					out.println("&nbsp;&nbsp;");
					for (int i = startBlock; i <= endBlock; i++) {
						if (i == cpage) {
					...
					// 페이지 번호들 나열해주고 해당 페이지의 데이터(게시글)들을 보여준다
					out.println("<span><a href='/passticketList.do?cpage=" + i + "&searchWord="+searchWord+"'>" + i + "</a></span>");
						}
					}
