...
<!doctype html>
<%
ArrayList<OsakaAreaTO> kobeList = (ArrayList) request.getAttribute("kobeList");
PageListTO pageTO = (PageListTO) request.getAttribute("pageTO");
ArrayList<OsakaAreaTO> pageList = pageTO.getPageList();
...
if (pageList.size() != 0) {
	for (OsakaAreaTO to : pageList) {
		String osakaId = to.getOsakaId();
		imageUrl = to.getImageUrl();
		title = to.getTitle();

		sbHtml.append("<li class='span4 mix all'>");
		sbHtml.append("<div class='thumbnail'>");
		sbHtml.append("<img src=" + imageUrl + " alt='project 7' style='width:360px; height:300px;' />");
		sbHtml.append("<h3 style='padding:50px; color:#ece6cc;'>" + title + "</h3>");
		sbHtml.append("<div class='mask'><a href='/kobeView.do?osakaId=" + osakaId + "'>GO</a></div>");
		sbHtml.append("</div>");
		sbHtml.append("</li>");
	}
...
<html class="no-js" lang="en">
	...
	<body>
        ...
        <div class="culmn">
			...
			<section id="kobe-list" class="home bg-black fix">
                        ...
                        <div class="main_home text-center">
                            <div class="col-md-12">
                                <div class="hello">
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h1 class="text-yellow">Kobe Guide </h1>                                                                              
            ...
            <div class="container">
                <div class=" title">
	               <div class="counter_text" style="color:black; padding:center; ">	
        				<span style="font-size:60px;"> Kobe <span style="font-size:60px; color:#8b00ff;">♥ </span></span> </span><span class="counter" style="text-decoration:none; font-size:60px;">40</span>  
        				<p> </p>                  
    				</div> 
	            </div>
	            <ul class="nav2 nav2-pills">
	                <li class="" data-filter="all">
	                    <a href="/osakaList.do">오사카</a>
	                </li>
	                <li class="" data-filter="web">
	                    <a href="/kyotoList.do">교토</a>
	                </li>
	                <li class="filter active" data-filter="photo">
	                    <a href="/kobeList.do">고베</a>
	                </li>
	                <li class="" data-filter="identity">
	                    <a href="/naraList.do">나라</a>
	                </li>		                
	                <li class="" data-filter="identity" style="float: right; display: flex; align-items: center;">
					    <form action="/kobeList.do" method="post" name="kfrm" style="display: flex; align-items: center;">
			...
			<div>
				...
				if (searchWord == null) {
					if (startBlock == 1) {
						...
						out.println("<span><a href='/kobeList.do?cpage=" + (startBlock - blockPerPage) + "'>&lt;&lt;</a></span>");
					}
					...
					if (cpage == 1) {
						...
						out.println("<span><a href='/kobeList.do?cpage=" + (cpage - 1) + "'>&lt;</a></span>");
					}
					out.println("&nbsp;&nbsp;");
					...
					out.println("<span><a href='/kobeList.do?cpage=" + i + "'>" + i + "</a></span>");
						}
					}
					...
					if (startBlock == 1) {
						...
						out.println("<span><a href='/kobeList.do?cpage=" + (startBlock - blockPerPage) + "&searchWord="+searchWord+"'>&lt;&lt;</a></span>");
					}
					...
					if (cpage == 1) {
						...
						out.println("<span><a href='/kobeList.do?cpage=" + (cpage - 1) + "&searchWord="+searchWord+"'>&lt;</a></span>");
					}
					out.println("&nbsp;&nbsp;");
					for (int i = startBlock; i <= endBlock; i++) {
						if (i == cpage) {
					...
					// 페이지 번호들 나열해주고 해당 페이지의 데이터(게시글)들을 보여준다
					out.println("<span><a href='/kobeList.do?cpage=" + i + "&searchWord="+searchWord+"'>" + i + "</a></span>");
						}
					}
                        ...
                        <div class="widget_area">
                            <div class="col-md-3">
                                <div class="widget_item widget_about">
                                    ...
                                    <p class="m-top-30" style="color:grey;">저희는 오사카를 가고싶은 청년들 입니다.
                                ...
                                <div class="widget_item widget_latest sm-m-top-50">
                                    ...
                                    <div class="widget_ab_item m-top-30">
                                        ...
                                        <div class="widget_ab_item_text">
                                            <p style="color:grey;">서울특별시 강남구 역삼동 819-10 세경빌딩 3층</p>
                                        </div>
                                    </div>
                                </div><!-- End off widget item -->
                            </div><!-- End off col-md-3 -->
