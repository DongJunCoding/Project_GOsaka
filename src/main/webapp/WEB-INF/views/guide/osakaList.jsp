...
// 여기서의 request.getParameter("cpage")도 url에 있는 cpage= 뒤에 오는 값을 가져오는듯 ...
...
if (pageList.size() != 0) {
	for (OsakaAreaTO to : pageList) {
		...
		sbHtml.append("<div class='mask'><a href='/osakaView.do?osakaId=" + osakaId + "'>GO</a></div>");
		sbHtml.append("</div>");
		sbHtml.append("</li>");
...
<html class="no-js" lang="en">
	...
	<body>
        ...
        <div class="culmn">
			...
			<section id="osaka-list" class="home bg-black fix">
                        ...
                        <div class="main_home text-center">
                            <div class="col-md-12">
                                <div class="hello">
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h1 class="text-yellow">Osaka Guide </h1>                                                                              
            ...
            <div class="container">
                <div class=" title">
                	<div class="counter_text" style="color:black; padding:center; ">	
        				<span style="font-size:60px;"> Osaka  <span style="font-size:60px; color:#ff7f00;">♥ </span></span> </span><span class="counter" style="text-decoration:none; font-size:60px;">67</span>  
        				<p> </p>                  
    				</div> 
	            </div>
	            <ul class="nav2 nav2-pills">
	                ...
	                <li class="" data-filter="identity" style="float: right; display: flex; align-items: center;">
					    <form action="/osakaList.do" method="get" name="ofrm" style="display: flex; align-items: center;">						    			    	
	...
	<!--페이지넘버-->
	<div class="paginate_regular" style="text-align: center; font-size: 25px; padding: 30px; background: #ece6cc;">
		<div>
			...
			if (searchWord == null) {
				if (startBlock == 1) {
					...
					out.println("<span><a href='/osakaList.do?cpage=" + (startBlock - blockPerPage) + "'>&lt;&lt;</a></span>");
				}
				...
				if (cpage == 1) {
					...
					out.println("<span><a href='/osakaList.do?cpage=" + (cpage - 1) + "'>&lt;</a></span>");
				}
				out.println("&nbsp;&nbsp;");
				...
				if (startBlock == 1) {
					...
					out.println("<span><a href='/osakaList.do?cpage=" + (startBlock - blockPerPage) + "&searchWord="+searchWord+"'>&lt;&lt;</a></span>");
				}
				...
				if (cpage == 1) {
					...
					out.println("<span><a href='/osakaList.do?cpage=" + (cpage - 1) + "&searchWord="+searchWord+"'>&lt;</a></span>");
				}
				out.println("&nbsp;&nbsp;");
				for (int i = startBlock; i <= endBlock; i++) {
					if (i == cpage) {
