...
<!DOCTYPE html>
<%
OsakaAreaTO osakaView = (OsakaAreaTO)request.getAttribute("to");
...
String osakaId = osakaView.getOsakaId();
String imageUrl = osakaView.getImageUrl();
String title = osakaView.getTitle();
String content = osakaView.getContent();
String latitude = osakaView.getLatitude();
String longitude = osakaView.getLongitude();
...
String information = null;
	...
	int endIdx = content.indexOf("<이용");
	  ...
	  if(startIdx != -1 && endIdx != -1) {
          ...
          location = content.substring(startIdx);
...
String sessionNick = (String)session.getAttribute("loginNick");
%>
