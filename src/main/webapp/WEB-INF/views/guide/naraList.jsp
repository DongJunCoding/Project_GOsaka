...
<!doctype html>
<%
ArrayList<OsakaAreaTO> naraList = (ArrayList) request.getAttribute("naraList");
...
if (pageList.size() != 0) {
	for (OsakaAreaTO to : pageList) {
		...
		sbHtml.append("<div class='mask'><a href='/naraView.do?osakaId=" + osakaId + "'>GO</a></div>");
		sbHtml.append("</div>");
		sbHtml.append("</li>");
...
<html class="no-js" lang="en">
	...
	<body>
        ...
        <div class="culmn">
			...
			<section id="nara-list" class="home bg-black fix">
                        ...
                        <div class="main_home text-center">
                            <div class="col-md-12">
                                <div class="hello">
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h1 class="text-yellow">Nara Guide </h1>                                                                              
            ...
            <div class="container">
                <div class=" title">
	            	<div class="counter_text" style="color:black; padding:center; ">	
        				<span style="font-size:60px;"> Nara  <span style="font-size:60px; color:#009900;">♥ </span></span> </span><span class="counter" style="text-decoration:none; font-size:60px;">19</span>  
        				<p> </p>                  
    				</div> 
	            </div>
	            <ul class="nav2 nav2-pills">
	                ...
	                <li class="" data-filter="photo">
	                    <a href="/kobeList.do">고베</a>
	                </li>
	                <li class="filter active" data-filter="identity">
	                    <a href="/naraList.do">나라</a>
	                </li>
	                <li class="" data-filter="identity" style="float: right; display: flex; align-items: center;">
					    <form action="/naraList.do" method="post" name="nfrm" style="display: flex; align-items: center;">
			...
			<div>
				...
				if (searchWord == null) {
					if (startBlock == 1) {
						...
						out.println("<span><a href='/naraList.do?cpage=" + (startBlock - blockPerPage) + "'>&lt;&lt;</a></span>");
					}
					...
					if (cpage == 1) {
						...
						out.println("<span><a href='/naraList.do?cpage=" + (cpage - 1) + "'>&lt;</a></span>");
					}
					out.println("&nbsp;&nbsp;");
					...
					out.println("<span><a href='/naraList.do?cpage=" + i + "'>" + i + "</a></span>");
						}
					}
					...
					if (startBlock == 1) {
						...
						out.println("<span><a href='/naraList.do?cpage=" + (startBlock - blockPerPage) + "&searchWord="+searchWord+"'>&lt;&lt;</a></span>");
					}
					...
					if (cpage == 1) {
						...
						out.println("<span><a href='/naraList.do?cpage=" + (cpage - 1) + "&searchWord="+searchWord+"'>&lt;</a></span>");
					}
					out.println("&nbsp;&nbsp;");
					for (int i = startBlock; i <= endBlock; i++) {
						if (i == cpage) {
					...
					// 페이지 번호들 나열해주고 해당 페이지의 데이터(게시글)들을 보여준다
					out.println("<span><a href='/naraList.do?cpage=" + i + "&searchWord="+searchWord+"'>" + i + "</a></span>");
						}
					}
