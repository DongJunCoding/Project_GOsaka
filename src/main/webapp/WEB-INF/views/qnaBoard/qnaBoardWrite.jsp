...
<script type="text/javascript">
	window.onload = function() {
		document.getElementById('wbtn').onclick = function() {
			if (document.qfrm.qsubject.value.trim() == '') {
				alert('제목을 입력하셔야 합니다');
				return false;
			}
			if (document.qfrm.qcontent.value.trim() == '') {
				alert('내용을 입력하셔야 합니다');
				return false;
			}
			
			document.qfrm.submit();
		};
	};
</script>
</head>
	...
	%>
		...
		<!-- 상단 디자인 -->
<div class="contents1"> 
	<form action="/qnaBoardWrite_ok.do" method="post" name="qfrm" enctype="multipart/form-data">
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th class="top">글쓴이</th>
					<td class="top" colspan="3"><input type="text" name="qwriter" value="<%=nickSession %>" class="board_view_input_mail" maxlength="10" style="height:25px;" readonly/></td>
				</tr>
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="qsubject" value="" class="board_view_input" style="height:25px;"/></td>
				</tr>
				<tr>
					<th>내용</th>
					<td colspan="3">
						<textarea name="qcontent" class="board_editor_area" style="height:500px;"></textarea>
					</td>
				</tr>
				<tr>
					<th>이미지</th>
